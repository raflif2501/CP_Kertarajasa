...
class ProdukSeeder extends Seeder
{
    ...
    {
        Produk::create([
            'nama' => 'Block Bottom Valve Bag',
            'deskripsi' => 'Our bags come with block bottom shape that can minimize space for storage and during transportation process, combined with valve for easy filling, especially for cement industry that is commonly using rotary packer to maximize their filling capacity.
        ...
        Produk::create([
            'nama' => 'Bulk Container Bag (FIBC)',
            'deskripsi' => 'FIBC is a container bag in large dimensions for storing and transporting various products which form is granular, powder, or flakes for example cement, sand, fertilizers, plastic resin and so on.
        ...
        Produk::create([
            'nama' => 'PP Woven Bag',
            'deskripsi' => 'PP Woven Bag is a bag made of woven polypropylene, mostly made on milky white color or transparent for various granular, powder, pellet or flake product in food and chemical industry.
